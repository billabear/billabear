    ...
    <div class="w-1/5">
      <div class="submenu-container">
        ...
        <ul>
          ...
          <li class="submenu-list-item"><router-link :to="{name: 'app.invoices.list'}" class="submenu-link"><i class="fa-solid fa-file-invoice"></i> {{ $t('app.transactions.menu.invoices') }}</router-link></li>
          <li class="submenu-list-item"><router-link :to="{name: 'app.invoices.unpaid_list'}" class="submenu-link"><i class="fa-solid fa-file-invoice-dollar"></i> {{ $t('app.transactions.menu.unpaid_invoices') }}</router-link></li>
        </ul>
      </div>
    </div>
