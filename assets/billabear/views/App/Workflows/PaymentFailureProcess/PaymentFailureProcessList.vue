  ...
  <div>
    ...
    <LoadingScreen :ready="ready">
      ...
      <div class="sm:grid sm:grid-cols-2">
        ...
        <div class="m-5">
          <button @click="prevPage" v-if="show_back" class="btn--main mr-3" >{{ $t('app.workflows.payment_failure_process.list.prev') }}</button>
...
export default {
  ...
  methods: {
    ...
    doStuff: function ()
    {
      ...
      var mode = 'normal';
      let urlString = '/app/system/payment-failure-process/list?';
