        ...
        <form @submit.prevent="handleSubmit" v-if="!password_requested">
          ...
          >
            ...
            <h1 class="h1 text-center text-3xl">
              {{ $t('public.forgot_password.title') }}
            </h1>
            ...
            <div class="px-5">
              <button
                ...
                v-if="!in_progress"
              >
                {{ $t('public.forgot_password.request_button') }}
              </button>
              <button
                type="submit"
              ...
              >
                <LoadingMessage>{{
                  $t('public.forgot_password.in_progress')
                }}</LoadingMessage>
              </button>
            </div>
            <div class="mt-5 px-5 mb-3 text-center">
              <router-link
                ...
                >{{ $t('public.forgot_password.login_link') }}</router-link
              >
            </div>
          </div>
        </form>
