    ...
    <form @submit.prevent="send">
      <div class="grid grid-cols-2 gap-3">
        <div class="card-body">
          ...
          <div class="form-field-ctn">
            ...
            <p class="form-field-help">
              {{
                $t('app.subscription_plan.create.main_section.help_info.public')
              }}
            </p>
          </div>
      ...
      <div class="form-field-submit-ctn">
        <SubmitButton :in-progress="sendingInProgress">{{
          $t('app.subscription_plan.update.submit_btn')
        }}</SubmitButton>
      </div>
      <p class="text-green-500 font-weight-bold" v-if="success">
        {{ $t('app.subscription_plan.update.success_message') }}
      </p>
    </form>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    this.fetchSubscriptionPlan({ productId, subscriptionPlanId })
      .then((response) => {
