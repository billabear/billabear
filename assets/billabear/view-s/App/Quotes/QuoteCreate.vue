    ...
    <div class="">
      <div class="card-body">
        <div class="form-field-ctn">
          ...
          <p class="form-field-help">
            {{ $t('app.quotes.create.customer.help_info.customer') }}
          </p>
        </div>
        ...
        <div class="form-field-ctn">
          ...
          <p class="form-field-help">
            {{ $t('app.quotes.create.customer.help_info.currency') }}
          </p>
        </div>
        <div class="form-field-ctn">
          <label class="form-field-lbl" for="name">
          ...
          <p class="form-field-error" v-if="errors.expiresAt != undefined">
            {{ errors.expiresAt }}
          </p>
          <VueDatePicker
            class="mt-2"
            v-model:value="quote.expires_at"
            :enable-time-picker="true"
          ></VueDatePicker>
          <p class="form-field-help">
            {{ $t('app.quotes.create.customer.help_info.expires_at') }}
          </p>
        </div>
      </div>
      ...
      <div class="card-body mt-5">
        <div class="grid grid-cols-2">
          <div>
            <h2 class="mb-3">
              {{ $t('app.quotes.create.subscriptions.title') }}
            </h2>
          </div>
          <div class="text-right">
            <button class="btn--main" @click="addSubscriptionPlan">
              {{ $t('app.quotes.create.subscriptions.add_subscription') }}
            </button>
          </div>
        </div>
        <table class="list-table">
          <thead>
            <tr>
              <th>
                {{
                  $t('app.quotes.create.subscriptions.list.subscription_plan')
                }}
              </th>
      ...
      <div class="card-body mt-5">
        <div class="grid grid-cols-2">
          <div>
            <h2 class="mb-3">{{ $t('app.quotes.create.items.title') }}</h2>
          </div>
          <div class="text-right">
            <button class="btn--main" @click="addItem">
              {{ $t('app.quotes.create.items.add_item') }}
            </button>
          </div>
        </div>
      ...
      <div class="mt-5">
        <SubmitButton
          ...
          class="btn--main"
          @click="createInvoice('quotes')"
          >{{ $t('app.quotes.create.create_quote') }}</SubmitButton
        >
      </div>
