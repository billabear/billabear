    ...
    <div class="grid grid-cols-2">
      ...
      <div class="mt-5 text-end top-button-container">
        <RoleOnlyView role="ROLE_ACCOUNT_MANAGER">
          <router-link :to="{ name: 'app.feature.create' }" class="btn--main"
            ><i class="fa-solid fa-user-plus"></i>
            {{ $t('app.feature.list.create_new') }}</router-link
          >
        </RoleOnlyView>
      </div>
    </div>
              ...
              <thead>
                <tr class="border-b border-black">
                  <th class="text-left pb-2">
                    {{ $t('app.feature.list.name') }}
                  </th>
                  <th class="text-left pb-2">
                    {{ $t('app.feature.list.code') }}
                  </th>
                </tr>
              </thead>
              <tbody v-if="loaded">
