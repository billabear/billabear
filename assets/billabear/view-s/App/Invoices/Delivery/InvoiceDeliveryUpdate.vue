      ...
      <form @submit.prevent="save">
        <div class="card-body">
          ...
          <div class="form-field-ctn">
            ...
            <select class="form-field" v-model="invoice_delivery.format">
              <option v-for="format in formatters" :value="format">
                {{ $t(format) }}
              </option>
            </select>
          </div>
        ...
        <div class="card-body mt-3" v-if="invoice_delivery.type === 'email'">
          <div class="form-field-ctn">
            ...
            <input
              type="text"
              class="form-field"
              v-model="invoice_delivery.email"
            />
            <p class="form-field-help">
              {{ $t('app.invoices.delivery.create.fields.email.help_info') }}
            </p>
          </div>
        </div>
        ...
        <div class="card-body mt-3" v-if="invoice_delivery.type === 'sftp'">
          <div class="form-field-ctn">
            ...
            <input
              type="text"
              class="form-field"
              v-model="invoice_delivery.sftp_user"
            />
          </div>
          ...
          <div class="form-field-ctn">
            ...
            <input
              type="text"
              class="form-field"
              v-model="invoice_delivery.sftp_password"
            />
          </div>
          ...
          <div class="form-field-ctn">
            ...
            <input
              type="text"
              class="form-field"
              v-model="invoice_delivery.sftp_host"
            />
          </div>
          ...
          <div class="form-field-ctn">
            ...
            <input
              type="number"
              class="form-field"
              v-model="invoice_delivery.sftp_port"
            />
          </div>
          ...
          <div class="form-field-ctn">
            ...
            <input
              type="text"
              class="form-field"
              v-model="invoice_delivery.sftp_dir"
            />
          </div>
        </div>
        ...
        <div class="card-body mt-3" v-if="invoice_delivery.type === 'webhook'">
          <div class="form-field-ctn">
            ...
            <select
              class="form-field"
              v-model="invoice_delivery.webhook_method"
            >
          ...
          <div class="form-field-ctn">
            ...
            <input
              type="text"
              class="form-field"
              v-model="invoice_delivery.webhook_url"
            />
          </div>
        </div>
        <div class="mt-3">
...
export default {
  ...
  mounted() {
    ...
    const url =
      '/app/customer/' + customerId + '/invoice-delivery/' + invoiceDeliveryId
