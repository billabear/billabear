<template>
  <div>
    <h1 class="page-title ml-5 mt-5">
      {{ $t('app.finance.integration.title') }}
    </h1>

    <LoadingScreen :ready="ready">
      <div class="card-body">
        <div class="alert-error mb-3" v-if="complete_error">
          {{ $t('app.finance.integration.errors.complete_error') }}
        </div>
      ...
      >
        <h2 class="text-2xl">
          {{ $t('app.finance.integration.settings.title') }}
        </h2>
        <div class="form-field-ctn">
          <label class="form-field-lbl" for="name">
      ...
      <SubmitButton
        ...
        class="btn--main mt-3"
        @click="saveSettings()"
        >{{ $t('app.finance.integration.buttons.save') }}</SubmitButton
      >
    </LoadingScreen>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    saveSettings() {
      ...
      axios
        .post('/app/integrations/accounting/settings', {
