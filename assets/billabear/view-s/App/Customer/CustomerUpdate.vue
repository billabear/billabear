        ...
        <div class="">
          <div class="mt-3 card-body">
            <div class="form-field-ctn">
              ...
              <p class="form-field-help">
                {{ $t('app.customer.update.help_info.email') }}
              </p>
            </div>
            <div class="form-field-ctn">
              ...
              />
              <p class="form-field-help">
                {{ $t('app.customer.update.help_info.locale') }}
              </p>
            </div>
            ...
            <div class="form-field-ctn">
              ...
              />
              <p class="form-field-help">
                {{ $t('app.customer.update.help_info.reference') }}
              </p>
            </div>
            ...
            <div class="form-field-ctn">
              ...
              <select class="form-field" id="type" v-model="customer.type">
                <option value="business">
                  {{ $t('app.customer.update.type_business') }}
                </option>
                <option value="individual">
                  {{ $t('app.customer.update.type_individual') }}
                </option>
              </select>
              <p class="form-field-help">
                {{ $t('app.customer.update.help_info.type') }}
              </p>
            </div>
            ...
            <div class="form-field-ctn">
              ...
              <p
                ...
                v-if="errors.billingType != undefined"
              >
                {{ errors.billingType }}
              </p>
              <select
              ...
              >
                <option value="card">
                  {{ $t('app.customer.update.billing_type_card') }}
                </option>
                <option value="invoice">
                  {{ $t('app.customer.update.billing_type_invoice') }}
                </option>
              </select>
              <p class="form-field-help">
                {{ $t('app.customer.update.help_info.billing_type') }}
              </p>
            </div>
            <div class="form-field-ctn">
              <label class="form-field-lbl" for="type">
              ...
              <p
                class="form-field-error"
                v-if="errors.marketingOptIn != undefined"
              >
                {{ errors.marketingOptIn }}
              </p>
              <Toggle v-model:value="customer.marketing_opt_in" />
              <p class="form-field-help">
                {{ $t('app.customer.update.help_info.marketing_opt_in') }}
              </p>
            </div>
          </div>
          ...
          <div class="card-body mt-5">
            ...
            <div class="form-field-ctn">
              ...
              />
              <p class="form-field-help">
                {{ $t('app.customer.update.help_info.standard_tax_rate') }}
              </p>
            </div>
            ...
            <div class="form-field-ctn">
              ...
              <p
                class="form-field-error"
                v-if="errors.invoiceFormat != undefined"
              >
                {{ errors.invoiceFormat }}
              </p>
              <select class="form-field" v-model="customer.invoice_format">
                <option value="pdf">PDF</option>
                <option value="zugferd_v1">
                  ZUGFeRD v1 - Factur-X/XRechung
                </option>
              </select>
              <p class="form-field-help">
                {{ $t('app.customer.update.help_info.invoice_format') }}
              </p>
            </div>
          </div>
          ...
          <div class="card-body mt-5">
            ...
            <div class="form-field-ctn">
              ...
              <p
                class="form-field-error"
                v-if="errors['address.company_name'] != undefined"
              >
                {{ errors['address.company_name'] }}
              </p>
              <input
                type="text"
                class="form-field-input"
                id="street_line_one"
                v-model="customer.address.company_name"
              />
              <p class="form-field-help">
                {{ $t('app.customer.update.help_info.company_name') }}
              </p>
            </div>
            <div class="form-field-ctn">
              <label class="form-field-lbl" for="street_line_one">
              ...
              />
              <p class="form-field-help">
                {{ $t('app.customer.update.help_info.street_line_one') }}
              </p>
            </div>
            ...
            <div class="form-field-ctn">
              ...
              />
              <p class="form-field-help">
                {{ $t('app.customer.update.help_info.street_line_two') }}
              </p>
            </div>
            ...
            <div class="form-field-ctn">
              ...
              />
              <p class="form-field-help">
                {{ $t('app.customer.update.help_info.city') }}
              </p>
            </div>
            ...
            <div class="form-field-ctn">
              ...
              />
              <p class="form-field-help">
                {{ $t('app.customer.update.help_info.region') }}
              </p>
            </div>
            ...
            <div class="form-field-ctn">
              ...
              />
              <p class="form-field-help">
                {{ $t('app.customer.update.help_info.country') }}
              </p>
            </div>
            <div class="form-field-ctn">
              ...
              />
              <p class="form-field-help">
                {{ $t('app.customer.update.help_info.post_code') }}
              </p>
            </div>
          </div>
          ...
          <div class="card-body mt-5">
            ...
            <table class="w-1/2">
              <thead>
                <tr>
                  <th class="text-left">
                    {{ $t('app.customer.update.metadata.name') }}
                  </th>
                  <th class="text-left">
                    {{ $t('app.customer.update.metadata.value') }}
                  </th>
                  <th></th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr v-if="metadata.length === 0">
                  <td colspan="4" class="text-center">
                    {{ $t('app.customer.update.metadata.no_values') }}
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <div class="form-field-ctn mt-3">
            <p @click="showAdvance = !showAdvance" class="cursor-pointer">
              ...
              <span class="ml-2">{{
                $t('app.customer.update.show_advanced')
              }}</span>
            </p>
          </div>
          <div class="card-body mt-3" v-if="showAdvance">
            <div class="form-field-ctn">
              ...
              />
              <p class="form-field-help">
                {{ $t('app.customer.update.help_info.external_reference') }}
              </p>
            </div>
          </div>
          ...
          <div class="form-field-submit-ctn mt-3">
            <SubmitButton :in-progress="sendingInProgress">{{
              $t('app.customer.update.submit_btn')
            }}</SubmitButton>
          </div>
          <p class="text-green-500 font-weight-bold" v-if="success">
            {{ $t('app.customer.update.success_message') }}
          </p>
        </div>
      </form>
    </LoadingScreen>
...
export default {
  ...
  methods: {
    ...
    send: function () {
      ...
      axios
        .post('/app/customer/' + customerId, payload)
        .then((response) => {
