    ...
    <form @submit.prevent="send">
      <div class="mt-3 card-body">
        <div class="form-field-ctn">
          ...
          <CurrencyInput v-model:value="creditNote.amount" />
        </div>
        <div class="form-field-ctn">
          ...
          <p class="form-field-help">
            {{ $t('app.credit.create.help_info.type') }}
          </p>
        </div>
        <div class="form-field-ctn">
          ...
          <CurrencySelect v-model:value="creditNote.currency" />
          <p class="form-field-help">
            {{ $t('app.credit.create.help_info.currency') }}
          </p>
        </div>
        <div class="form-field-ctn">
          <label class="form-field-lbl" for="currency">
...
export default {
  name: 'CustomerCreate',
  components: { CurrencyInput, CurrencySelect, SettingsGroup },
  data() {
    return {
      creditNote: {
        amount: 0,
  ...
  methods: {
    ...
    send: function () {
      ...
      axios
        .post('/app/customer/' + customerId + '/credit', this.creditNote)
        .then((response) => {
