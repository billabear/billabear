  ...
  <div>
    ...
    <LoadingScreen :ready="loaded">
      <div class="card-body">
        <div class="form-field-ctn">
          ...
          <p class="form-field-help">
            {{ $t('app.state.edit.state.help_info.name') }}
          </p>
        </div>
        ...
        <div class="form-field-ctn">
          ...
          <p class="form-field-help">
            {{ $t('app.state.edit.state.help_info.code') }}
          </p>
        </div>
        ...
        <div class="form-field-ctn">
          ...
          <p class="form-field-help">
            {{ $t('app.state.edit.state.help_info.collecting') }}
          </p>
        </div>
        ...
        <div class="form-field-ctn">
          ...
          <p class="form-field-help">
            {{ $t('app.state.edit.state.help_info.threshold') }}
          </p>
        </div>
      ...
      <SubmitButton class="mt-3" :in-progress="sending" @click="sendCreate">{{
        $t('app.state.edit.update_button')
      }}</SubmitButton>
    </LoadingScreen>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    axios
      .get(
        `/app/country/${countryId}/state/${stateId}/view`,
  ...
  methods: {
    sendCreate: function () {
      ...
      const stateId = this.$route.params.stateId
      axios
        .post(`/app/country/${countryId}/state/${stateId}/edit`, this.state)
        .then((response) => {
          this.$router.push({
