    ...
    <LoadingScreen :ready="ready">
        ...
        <div class="card-body">
          <div class="form-field-ctn">
            ...
            <p class="form-field-help">
              {{ $t('app.country.create.country.help_info.name') }}
            </p>
          </div>
          <div class="form-field-ctn">
            <label class="form-field-lbl" for="name">
            ...
            <p class="form-field-help">
              {{ $t('app.country.create.country.help_info.iso_code') }}
            </p>
          </div>
          <div class="form-field-ctn">
            <label class="form-field-lbl" for="name">
          ...
          <div class="form-field-ctn">
            ...
            <VueDatePicker
              class="mt-2"
              v-model:value="country.tax_year"
              :enable-time-picker="false"
              :format="'dd/MMM'"
              model-type="dd/MMM"
            ></VueDatePicker>
            <p class="form-field-help">
              {{ $t('app.country.create.country.help_info.tax_year') }}
            </p>
          </div>
          <div class="form-field-ctn">
            <label class="form-field-lbl" for="name">
            ...
            />
            <p class="form-field-help">
              {{ $t('app.country.create.country.help_info.threshold') }}
            </p>
          </div>
          <div class="form-field-ctn">
            ...
            <Toggle v-model:value="country.in_eu" />
            <p class="form-field-help">
              {{ $t('app.country.create.country.help_info.in_eu') }}
            </p>
          </div>
          <div class="form-field-ctn">
            ...
            <p class="form-field-help">
              {{ $t('app.country.create.country.help_info.collecting') }}
            </p>
          </div>
          <div class="form-field-ctn">
            <label class="form-field-lbl" for="name">
            ...
            />
            <p class="form-field-help">
              {{ $t('app.country.create.country.help_info.tax_number') }}
            </p>
          </div>
      ...
      <div class="mt-5 ml-5">
        <SubmitButton :in-progress="sending" @click="send">{{
          $t('app.country.create.create_button')
        }}</SubmitButton>
      </div>
    </LoadingScreen>
  </div>
