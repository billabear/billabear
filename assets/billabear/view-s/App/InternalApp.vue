<template>
  <LoadingScreen :ready="ready" v-if="!error">
    <div class="h-screen w-screen md:flex">
      <div
        class="hidden md:block sticky w-72 bg-teal-500 text-white overflow-auto"
      >
      ...
      <div
        class="md:flex-1 bg-gray-100 p-5 divide-y divide-gray-200 overflow-auto h-screen"
      >
        ...
        <div class="pt-2">
          <div
            class="rounded-xl p-3 bg-red-500 text-white font-bold"
            v-if="!has_stripe_key"
          >
