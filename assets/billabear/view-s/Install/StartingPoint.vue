        ...
        <div class="mx-auto" :class="{ 'animate-shake': error_info.has_error }">
          ...
          <div class="px-5 mb-3">
            <label class="block mb-1">{{
              $t('install.settings.default_brand')
            }}</label>
            <p
              class="form-field w-full-error"
              v-if="errors.defaultBrand != undefined"
            >
              {{ errors.defaultBrand }}
            </p>
            <input
              ...
              v-model="default_brand"
            />
          </div>
          <div class="px-5 mb-3">
            <label class="block mb-1">{{
              $t('install.settings.country')
            }}</label>
            <p
              class="form-field w-full-error"
            ...
            <CountrySelect class="w-full" v-model:value="country" />
          </div>
          <div class="px-5 mb-3">
            <label class="block mb-1">{{
              $t('install.settings.currency')
            }}</label>
            <p
              class="form-field w-full-error"
            ...
            <CurrencyRate class="w-full" v-model:value="currency" />
          </div>
          <div class="px-5 mb-3">
            <label class="block mb-1">{{
              $t('install.settings.from_email')
            }}</label>
            <p
              class="form-field w-full-error"
              v-if="errors.fromEmail != undefined"
            >
              {{ errors.fromEmail }}
            </p>
          ...
          <div class="px-5 mb-3">
            <label class="block mb-1">{{
              $t('install.settings.timezone')
            }}</label>
            <p
              class="form-field w-full-error"
              v-if="errors.timezone != undefined"
            >
              {{ errors.timezone }}
            </p>
          ...
          <div class="px-5 mb-3">
            <label class="block mb-1">{{
              $t('install.settings.webhook_url')
            }}</label>
            <p
              class="form-field w-full-error"
              v-if="errors.webhooKurl != undefined"
            >
              {{ errors.webhooKurl }}
            </p>
            <input
          ...
          <div class="px-5 mb-3">
            ...
            <p class="form-field w-full-error" v-if="errors.email != undefined">
              {{ errors.email }}
            </p>
          ...
          <div class="px-5">
            <SubmitButton class="w-full" :in-progress="sendingInProgress">{{
              $t('install.submit_button')
            }}</SubmitButton>
          </div>
        </div>
      </form>
      <div v-else>
        ...
        <p class="text-center">
          <router-link
            ...
            >{{ $t('install.login_link') }}</router-link
          >
        </p>
      </div>
    </div>
