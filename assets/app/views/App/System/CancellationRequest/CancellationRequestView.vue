<template>
  <div>
    <h1 class="page-title">{{ $t('app.system.cancellation_request.view.title') }}</h1>

    <LoadingScreen :ready="ready">
      <div class="mx-5 grid grid-cols-2 gap-5">

        <div class="card-body">
          <div class="section-header">{{ $t('app.system.cancellation_request.view.subscription.title') }}</div>
          <dl class="detail-list">
            <div>
              <dt>{{ $t('app.system.cancellation_request.view.subscription.name') }}</dt>
              <dd>{{ cancellation_request.subscription.plan.name }}</dd>
            </div>
            <div>
              <dt>{{ $t('app.system.cancellation_request.view.subscription.customer') }}</dt>
            ...
            <div>
              <dt>{{ $t('app.system.cancellation_request.view.subscription.original_cancellation_date') }}</dt>
