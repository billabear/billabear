    ...
    <div>
      <div class="submenu-container">
        <ul>
          ...
          <li class="submenu-list-item"><router-link :to="{name: 'app.finance.country.list'}" class="submenu-link">{{ $t('app.system.menu.countries') }}</router-link></li>
          <li class="submenu-list-item"><router-link :to="{name: 'app.finance.tax_type.list'}" class="submenu-link">{{ $t('app.system.menu.tax_types') }}</router-link></li>
        </ul>
      </div>
    </div>
