    ...
    <div class="w-1/5">
      <div class="submenu-container">
        ...
        <ul>
          ...
          <li class="submenu-list-item"><router-link :to="{name: 'app.checkout.list'}" class="submenu-link"><i class="fa-solid fa-triangle-exclamation"></i> {{ $t('app.transactions.menu.checkout') }}</router-link></li>
        </ul>
      </div>
    </div>
