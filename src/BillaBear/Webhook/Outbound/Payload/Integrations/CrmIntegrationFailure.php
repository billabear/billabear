...
class CrmIntegrationFailure implements PayloadInterface
{
    ...
    {
        return WebhookEventType::INTEGRATION_CRM_FAILURE;
    }

    public function getPayload(): array
    {
        return [
            'type' => WebhookEventType::INTEGRATION_CRM_FAILURE->value,
