...
use BillaBear\Integrations\Crm\Messenger\SyncCustomer;
...
#[AsCommand(
    name: 'billabear:integration:crm:customer-sync',
...
class CustomerSyncCommand extends Command
{
    ...
    {
        $output->writeln('Syncing customers to CRM system');
        $settings = $this->settingsRepository->getDefaultSettings();

        if (!$settings->getCrmIntegration()->getEnabled()) {
            $output->writeln('No CRM integration set up');
