...
class EconomicArea
{
    ...
    #[ORM\OneToMany(targetEntity: EconomicAreaMembership::class, mappedBy: 'economicArea', cascade: ['persist'])]
    ...
    /**
     * @return Collection|EconomicAreaMembership[]
     */
