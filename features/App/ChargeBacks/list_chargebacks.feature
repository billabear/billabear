Feature: Payment List Read APP
  ...
  Scenario: Get customer info
    ...
    And there is a charge back for the payment for "customer.one@example.org" for 3500
    When I view the charge back list
    Then I will see a charge back for payment for "customer.one@example.org" for 3500
