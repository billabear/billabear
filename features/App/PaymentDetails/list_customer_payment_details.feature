Feature: Customer Read APP
  ...
  Scenario: Get customer info
    ...
    When I view the payment details info for the customer via the site for "customer.one@example.org"
    Then I will see the payment details in the list with the last four "0444"
