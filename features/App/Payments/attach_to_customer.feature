Feature: Attach payment to customer
  ...
  Scenario: Get customer info
    ...
    And there is a payments for:
      | Subscription Plan | Customer                 | Amount | Currency |
      | Test Plan         | customer.one@example.org | 3500   | USD      |
      | Test Plan         |                          | 6500   | USD      |
    When I attach the payment for 6500 "USD" to "customer.two@example.org"
    Then the payment for 6500 "USD" should belong to "customer.two@example.org"