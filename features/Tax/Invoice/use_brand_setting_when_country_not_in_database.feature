Feature: Use brand setting when country not in database
  ...
  Background:
    ...
    And the follow brands exist:
      | Name    | Code                    | Email               | Country | Tax Rate |
      | Example | example                 | example@example.org | ZA      | 12       |
    ...
    And the follow products exist:
      ...
      | Product Two   | prod_jf9j542       | Digital Services | False    |
      | Product Three | prod_jf9j542       | Physical         | True     |
    And the follow prices exist:
      | Product       | Amount | Currency | Recurring | Schedule | Public |
      | Product One   | 1000   | USD      | true      | week     | true   |
      | Product Three | 1001   | USD      | true      | week     | true   |
  ...
  Scenario: Standard Tax Rate
    ...
    Given the following subscriptions exist:
      ...
      | Physical Plan     | 1001         | USD            | week           | customer.south@example.org | +3 Minutes  | Active |
