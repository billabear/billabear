Feature: view country membership to economic areas
  ...
  Scenario: Successfully create economic area
    ...
    When I view the member "Germany" from the economic area "European Economic Area"
    Then I will see see that member joined at "1959-01-01"
