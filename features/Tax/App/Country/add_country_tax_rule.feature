Feature: Add Country Tax Rule
  ...
  Scenario: Successfully create tax type and sets valid until on rule with no valid until
    ...
    When I create a country tax rule with the following data:
      ...
      | Tax Rate   | 15            |
      | Valid From | -3 days       |
    Then there should be a tax rule for "United States" for "Digital" tax type with the tax rate 17.5 that is valid until "-3 days"
  ...
  Scenario: Successfully create tax type and sets but does not set valid until on rule with no valid until
    ...
    When I create a country tax rule with the following data:
      ...
      | Valid From  | -23 days      |
      | Valid Until | -11 days      |
    Then there should be a tax rule for "United States" for "Digital" tax type with the tax rate 17.5 that is open ended