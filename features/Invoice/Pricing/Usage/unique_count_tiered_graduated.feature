Feature: Latest Tier Graduated Pricing usage
  ...
  Scenario: Latest usage
    ...
    And the following events exist:
      ...
      | Test One | customer.one@example.org | Test Plan         | 2     | 15       | -15 days   | {"hour": 12, "minute": 9} |
      | Test One | customer.one@example.org | Test Plan         | 2     | 15       | -7 days    | {"hour": 35, "minute": 4} |
      | Test One | customer.one@example.org | Test Plan         | 2     | 15       | -1 hour    | {"hour": 25, "minute": 4} |
  ...
  Scenario: Latest usage
    ...
    And the following events exist:
      | Metric   | Customer                 | Subscription Plan | Value | Repeated | Created At | Properties                |
      | Test One | customer.one@example.org | Test Plan         | 1     | 5        | -6 months  | {"hour": 26, "minute": 4} |
      | Test One | customer.one@example.org | Test Plan         | 1     | 25       | -5 months  | {"hour": %d, "minute": 4} |
    And stripe billing is disabled
    When the background task to reinvoice active subscriptions
  ...
  Scenario: Latest usage
    ...
    And the following events exist:
      ...
      | Test One | customer.one@example.org | Test Plan         | 1     | 5        | -1 days    | {"hour": %d, "minute": 4} |
    And stripe billing is disabled
    When the background task to reinvoice active subscriptions
  ...
  Scenario: Latest usage
    Given the follow metrics exist:
      ...
      | Test One | test_one | Resettable | Unique Count       | hour                 | Real Time | {"colour": {"value": "yellow", "type": "inclusive"}} |
    Given the follow price "Product One" for "USD" weekly price with a usage tiered graduated for metric "Test One" with these tiers:
      | First Unit | Last Unit | Unit Price | Flat Fee |
      | 1          | 20        | 0          | 1000     |
      | 21         | -1        | 0          | 1500     |
    ...
    And the following events exist:
      ...
      | Test One | customer.one@example.org | Test Plan         | 1     | 5        | -3 days    | {"colour": "yellow", "hour": %d, "minute": 4} |
      | Test One | customer.one@example.org | Test Plan         | 1     | 5        | -2 days    | {"colour": "yellow", "hour": %d, "minute": 4} |
      | Test One | customer.one@example.org | Test Plan         | 1     | 16       | -3 days    | {"colour": "blue", "hour": %d, "minute": 4}   |
    And stripe billing is disabled
    When the background task to reinvoice active subscriptions
    Then the subscription for "customer.one@example.org" will expire in a week
    And there the latest invoice for "customer.one@example.org" will be for 1000 "USD"
  ...
  Scenario: Latest usage
    Given the follow metrics exist:
      | Name     | Code     | Type       | Aggregation Method | Aggregation Property | Ingestion | Filters                                              |
      | Test One | test_one | Resettable | Unique Count       | hour                 | Real Time | {"colour": {"value": "yellow", "type": "exclusive"}} |
    Given the follow price "Product One" for "USD" weekly price with a usage tiered graduated for metric "Test One" with these tiers:
      | First Unit | Last Unit | Unit Price | Flat Fee |
      | 1          | 20        | 0          | 1000     |
      | 21         | -1        | 0          | 1500     |
    ...
    And the following events exist:
      ...
      | Test One | customer.one@example.org | Test Plan         | 1     | 5        | -5 months  | {}                                            |
      | Test One | customer.one@example.org | Test Plan         | 1     | 5        | -3 days    | {"colour": "yellow", "hour": %d, "minute": 4} |
      | Test One | customer.one@example.org | Test Plan         | 2     | 16       | -3 days    | {"colour": "blue", "hour": %d, "minute": 4}   |
      | Test One | customer.one@example.org | Test Plan         | 2     | 16       | -1 days    | {"colour": "blue", "hour": %d, "minute": 4}   |
    And stripe billing is disabled
    When the background task to reinvoice active subscriptions
    Then the subscription for "customer.one@example.org" will expire in a week
    And there the latest invoice for "customer.one@example.org" will be for 2500 "USD"
