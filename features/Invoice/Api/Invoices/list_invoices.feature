Feature: List invoices
  ...
  Scenario:
    Given the following invoices exist:
      | Customer                 |
      | customer.one@example.org |
    And I have authenticated to the API
    When I view the invoice list for "customer.one@example.org"
    Then I will see an invoice for "customer.one@example.org"
