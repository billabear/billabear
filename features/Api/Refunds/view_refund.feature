Feature: Refund Read API
  In order to know refund info
  As an API user
  I need to be to fetch refund info
  ...
  Scenario: Get customer info
    ...
    When I view the full refund for a payment for "customer.one@example.org" for 3500 via API
    Then I will see the refund api response has the amount of 3500
