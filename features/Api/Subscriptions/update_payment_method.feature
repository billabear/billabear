Feature: Customer Subscription Update Payment Method APP
  ...
  Scenario: Update payment method
    ...
    When I update the subscription "Test Plan" for "customer.one@example.org" to use the Payment method "0444" via API
    Then the subscription "Test Plan" for "customer.one@example.org" will have the Payment Method "0444"
