Feature:
  ...
  Scenario: Cancel subscription
    ...
    When I cancel via the stripe interopt api the subscription "Test Plan" for "customer.one@example.org"
  ...
  Scenario: Cancel subscription
    ...
    And the following subscriptions exist:
      ...
      | Test Plan         | 3000         | USD            | month          | customer.two@example.org   |
      | Test Plan         | 3000         | USD            | month          | customer.three@example.org |
    When I cancel via the stripe interopt api the subscription "Test Plan" for "customer.one@example.org" with prorata cancellation
