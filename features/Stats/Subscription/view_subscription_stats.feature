Feature: Customer Subscription Update Payment Method APP
  ...
  Scenario: Get customer info
    ...
    And the following subscriptions exist:
      ...
      | Test Plan         | 30000        | USD            | year          | customer.two@example.org |
      | Test Two          | 3000         | USD            | month          | customer.one@example.org |
    When I view the subscription stats
    Then I will see the subscription count for "Test Plan" as 2
    And I will see the subscription count for "Test Two" as 1
    And I will see the yearly subscription count as 1
    And I will see the monthy subscription count as 2