Feature: List Checkouts
  ...
  Scenario: View Checkout
    ...
    And a permanent checkout called "Test 2" exists in "USD":
      | Description | Total | Sub Total | Vat Total |
      | Setup costs | 12000 | 8000      | 4000      |
    When I view the checkout list in the APP
    Then I will see a checkout in the list called "Test"
    And I will see a checkout in the list called "Test 2"