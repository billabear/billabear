Feature: Charge invoices
  ...
  Scenario:
    ...
    And there is a manage customer session for "customer.two@example.org" that expires in "+5 minutes"
    When charge the invoice for "customer.two@example.org" via the portal
