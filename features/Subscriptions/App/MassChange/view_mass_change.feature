...
# 1 at 3400 GBP #                 # 1 Test Plan at 3300 USD #
  ...
  Scenario: Create Mass Change change
    ...
    When I view the mass subscription change with the target subscription plan "Test Plan"
    Then I will see the mass subscription change for the target subscription plan "Test Plan"