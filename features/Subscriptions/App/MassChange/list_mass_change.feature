Feature: Create Subscription Mass Change
  ...
  Scenario: Create Mass Change change
    ...
    And there are the following mass subscription changes exists:
      ...
      | Test Plan                | +1 days     | Test Two              |
      | Test Plan                | +12 days    | Test Two              |
      | Test Plan                | +21 days    | Test Two              |
      | Test Plan                | +41 days    | Test Two              |
      | Test Plan                | +31 days    | Test Two              |
      | Test Plan                | +10 days    | Test Two              |
    When I look at the mass subscription change list
    Then I will see there are 6 mass subscriptions changes in the list