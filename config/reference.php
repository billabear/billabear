 ...
 *     }>,
 * }
 * @psalm-type ParthenonConfig = array{
 *     athena?: array{
 *         enabled?: bool|Param,
 *         host?: scalar|Param|null,
 *         login_logo?: scalar|Param|null,
 *         dashboard_logo?: scalar|Param|null,
 *     },
 *     ab_testing?: array{
 *         enabled?: bool|Param,
 *         provider?: scalar|Param|null, // Default: "parthenon"
 *         optimizely?: array{
 *             api_key?: scalar|Param|null,
 *         },
 *         parthenon?: array{
 *             report_handler_service?: scalar|Param|null,
 *             dbal_connection_service?: scalar|Param|null,
 *             predefined_decisions_enabled?: bool|Param,
 *             predefined_decisions_redis_service?: scalar|Param|null,
 *             log_user_results?: bool|Param,
 *             disabled_user_agents?: list<scalar|Param|null>,
 *         },
 *     },
 *     common?: array{
 *         site_url?: scalar|Param|null,
 *         elasticsearch?: array{
 *             hosts?: list<scalar|Param|null>,
 *             connection_type?: scalar|Param|null,
 *             cloud_id?: scalar|Param|null,
 *             api_key?: scalar|Param|null,
 *             api_id?: scalar|Param|null,
 *             basic_username?: scalar|Param|null,
 *             basic_password?: scalar|Param|null,
 *         },
 *         pdf?: array{
 *             generator?: scalar|Param|null,
 *             mpdf?: array{
 *                 tmp_dir?: scalar|Param|null, // Default: "/tmp"
 *             },
 *             docraptor?: array{
 *                 api_key?: scalar|Param|null,
 *             },
 *             wkhtmltopdf?: array{
 *                 bin?: scalar|Param|null, // Default: "/usr/bin/wkhtmltopdf"
 *             },
 *         },
 *         uploader?: array<string, array{ // Default: []
 *             provider?: scalar|Param|null,
 *             naming_strategy?: scalar|Param|null,
 *             url?: scalar|Param|null,
 *             local?: array{
 ...
 *         email_confirmation?: bool|Param, // Default: true
 *         signed_in_after_signup?: bool|Param, // Default: false
 *         user_invites_enabled?: bool|Param, // Default: false
 *         login_route?: scalar|Param|null, // Default: "parthenon_user_login"
 *         login_redirect_route?: scalar|Param|null, // Default: "parthenon_user_profile"
 *         signup_success_route?: scalar|Param|null, // Default: "parthenon_user_signed_up"
 *         teams_enabled?: bool|Param, // Default: false
 *         teams_invites_enabled?: bool|Param, // Default: false
 *         self_signup_enabled?: bool|Param, // Default: true
 *         team_class?: scalar|Param|null,
 *         firewall_name?: scalar|Param|null,
 *         roles?: array{
 *             default_role?: scalar|Param|null, // Default: "ROLE_USER"
 *             user_assignable?: array<string, scalar|Param|null>,
 *             athena_assignable?: array<string, scalar|Param|null>,
 *         },
 *         gdpr?: array{
 *             export?: array{
 *                 export_format?: scalar|Param|null,
 *             },
 *         },
 *     },
 *     notification?: array{
 *         enabled?: bool|Param,
 *         email?: array{
 *             from_address?: scalar|Param|null, // Default: "parthenon@example.org"
 *             from_name?: scalar|Param|null, // Default: "Parthenon"
 *             provider?: scalar|Param|null,
 *             send_via_queue?: bool|Param, // Default: false
 *             postmark?: array{
 *                 api_key?: scalar|Param|null,
 *             },
 *             mailgun?: array{
 ...
 *             redirect_url?: scalar|Param|null,
 *         },
 *     },
 *     payments?: array{
 *         enabled?: bool|Param,
 *         provider?: scalar|Param|null,
 *         success_redirect_route?: scalar|Param|null,
 *         cancel_checkout_redirect_route?: scalar|Param|null,
 *         stripe?: array{
 *             private_api_key?: scalar|Param|null,
 *             public_api_key?: scalar|Param|null,
 *             success_url?: scalar|Param|null,
 *             cancel_url?: scalar|Param|null,
 *             return_url?: scalar|Param|null,
 *         },
 *         transaction_cloud?: array{
 *             api_key?: scalar|Param|null,
 *             api_key_password?: scalar|Param|null,
 *             sandbox?: bool|Param, // Default: false
 *             customer_id_parameter?: scalar|Param|null,
 *             payment_id_parameter?: scalar|Param|null,
 *         },
 *         subscriptions?: array{
 *             subscriber_type?: scalar|Param|null,
 *             plan?: array<string, array{ // Default: []
 *                 is_free?: bool|Param, // Default: false
 *                 is_per_seat?: bool|Param, // Default: false
 *                 user_count?: scalar|Param|null,
 *                 features?: list<scalar|Param|null>,
 *                 limit?: array<string, array{ // Default: []
 *                     limit?: int|Param,
 *                     description?: scalar|Param|null,
 *                 }>,
 *             }>,
 *         },
 *         price?: array<string, array<string, array{ // Default: []
 *             price?: scalar|Param|null,
 *             price_id?: scalar|Param|null,
 *             subscription?: bool|Param,
 *             trial_day_length?: scalar|Param|null,
 *         }>>,
 *     },
 *     funnel?: array{
 *         enabled?: bool|Param,
 ...
 *     multi_tenancy?: array{
 *         enabled?: bool|Param, // Default: false
 *         background_creation?: bool|Param, // Default: false
 *         domain?: scalar|Param|null,
 *         domain_format?: scalar|Param|null,
 *         doctrine?: array{
 *             dbal_connection?: scalar|Param|null,
 *             global_dbal_connection?: scalar|Param|null,
 *             global_orm_entity_manager?: scalar|Param|null,
 *             orm_entity_manager?: scalar|Param|null,
 *             default_database?: scalar|Param|null,
 *         },
 *         database_creation_strategy?: scalar|Param|null,
 *         migrations?: array{
 *             directory?: scalar|Param|null,
 *         },
 *         digitalocean?: array{
 *             cluster_id?: scalar|Param|null,
 *         },
 *     },
 *     cloud?: array{
 *         enabled?: bool|Param, // Default: false
 ...
 *     export?: array{
 *         enabled?: bool|Param, // Default: false
 *         default_engine?: scalar|Param|null, // Default: "direct_download"
 *         user_provider?: scalar|Param|null,
 *     },
 *     billing?: array{
 *         enabled?: bool|Param, // Default: false
 *         customer_type?: scalar|Param|null, // Default: "team"
 *         plan_management?: scalar|Param|null, // Default: "config"
 *         billabear?: array{
 *             enabled?: bool|Param, // Default: false
 *             api_url?: scalar|Param|null,
 *             api_key?: scalar|Param|null,
 ...
 *             adyen?: array{
 *                 api_key?: scalar|Param|null,
 *                 merchant_account?: scalar|Param|null,
 *                 test_mode?: bool|Param,
 *                 webhook_secret?: scalar|Param|null,
 *                 prefix?: scalar|Param|null,
 *                 cse_url?: scalar|Param|null,
 *             },
 *             stripe?: array{
 *                 private_api_key?: scalar|Param|null,
 *                 webhook_secret?: scalar|Param|null,
 *                 public_api_key?: scalar|Param|null,
 *                 product_id?: scalar|Param|null,
 *                 payment_methods?: list<scalar|Param|null>,
 *             },
 *         },
 *         plan?: array<string, array{ // Default: []
 *             is_free?: bool|Param, // Default: false
 *             is_per_seat?: bool|Param, // Default: false
 *             public?: bool|Param, // Default: true
 *             has_trial?: bool|Param, // Default: false
 *             trial_length_days?: scalar|Param|null, // Default: 0
 *             user_count?: scalar|Param|null,
 *             features?: list<scalar|Param|null>,
 *             limit?: array<string, array{ // Default: []
 *                 limit?: int|Param,
 *                 description?: scalar|Param|null,
 *             }>,
 *             prices?: array<string, list<array{ // Default: []
 *                 amount?: scalar|Param|null,
 *                 price_id?: scalar|Param|null,
 *                 public?: bool|Param, // Default: true
 *             }>>,
 *         }>,
