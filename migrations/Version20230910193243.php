 ...
 */
final class Version20230910193243 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE checkout_session (id UUID NOT NULL, customer_id UUID DEFAULT NULL, checkout_id UUID DEFAULT NULL, currency VARCHAR(255) NOT NULL, amount_due INT DEFAULT NULL, total INT DEFAULT NULL, sub_total INT DEFAULT NULL, tax_total INT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
